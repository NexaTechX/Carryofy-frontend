        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 mb-10 sm:mb-12">
              ...
              <Link
                href="/products"
                className="group px-8 py-4 bg-white text-gray-900 rounded-xl hover:bg-gray-50 border-2 border-gray-200 hover:border-primary/30 transition-all duration-300 font-semibold text-base sm:text-lg flex items-center justify-center gap-2 shadow-sm hover:shadow-md"
              >
                Explore Products
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
            ...
            >
              <div className="flex items-center gap-2.5 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-lg border border-gray-100 shadow-sm">
                ...
                <span className="font-medium text-gray-700">Verified vendors</span>
              </div>
              <div className="flex items-center gap-2.5 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-lg border border-gray-100 shadow-sm">
                <div className="w-5 h-5 rounded-full bg-green-100 flex items-center justify-center">
                  <Check className="w-3.5 h-3.5 text-green-600" />
