...
const features = [
  ...
  },
  {
    ...
    description: 'Smarter ways to find and compare stock as new tools roll out on the platform.',
  },
];
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="font-inter font-bold text-[#111111] text-lg mb-2">{feature.title}</h3>
