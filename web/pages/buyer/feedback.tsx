...
export default function BuyerFeedbackPage() {
  ...
  return (
    <>
      <Head>
        <title>Feedback - Buyer | Carryofy</title>
        ...
        <div>
          ...
          <div className="mb-8">
            ...
            <p className="text-[#ffcc99] text-lg">
              Help us improve! Share your thoughts and suggestions about your shopping experience.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-[#1a1a1a] border border-[#ff6600]/30 rounded-xl p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-[#ffcc99]">
                  Your feedback helps us create a better shopping experience for everyone.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmitFeedback} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="products">Product Selection</option>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-[#1a1a1a] border border-[#ff6600]/30 rounded-xl p-6 text-center">
                ...
                <h3 className="text-white font-bold mb-2">Improve Products</h3>
                <p className="text-[#ffcc99] text-sm">
                  Help us offer better products that meet your needs
                </p>
              </div>
              <div className="bg-[#1a1a1a] border border-[#ff6600]/30 rounded-xl p-6 text-center">
                ...
                <p className="text-[#ffcc99] text-sm">
                  Shape a better shopping experience for all users
                </p>
              </div>
              <div className="bg-[#1a1a1a] border border-[#ff6600]/30 rounded-xl p-6 text-center">
