import { CheckCircle, ShoppingBag, Truck, CreditCard, Layers } from 'lucide-react';
    ...
    const solutions = [
        {
            icon: Layers,
            title: 'One platform',
            description: 'Marketplace, warehouse, and delivery — unified.',
        },
        {
            icon: ShoppingBag,
            title: 'Verified sellers',
            description: 'Vetted businesses you can trust.',
        },
        {
            icon: Truck,
            title: 'Same-day delivery',
            description: 'Order by noon, receive today.',
        },
        {
            icon: CreditCard,
            title: 'Buyer protection',
            description: 'Secure payments. Money-back guarantee.',
        },
    ];
                ...
                <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
                    <div>
                        ...
                        <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                            {[
                                'Verified sellers — every vendor vetted',
                                'Fulfillment by Carryofy — we store and pack',
                    ...
                    <div className="relative">
                        <div className="absolute inset-0 bg-gradient-to-br from-[#FF6B00]/5 to-[#FF6B00]/10 rounded-2xl sm:rounded-3xl -rotate-2 sm:-rotate-3"></div>
                        <div className="relative bg-white border border-gray-100 rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-6 lg:p-8 grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                            {solutions.map((solution, index) => (
                                <motion.div
                                    ...
                                    className="bg-gray-50 p-4 sm:p-5 lg:p-6 rounded-lg sm:rounded-xl text-center hover:bg-[#FF6B00]/5 transition-colors"
                                >
                                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FF6B00]/10 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 text-[#FF6B00]">
