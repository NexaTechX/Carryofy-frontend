...
export interface AdminSeller {
  ...
  businessOperatesFrom?: string | null;
  marketName?: string | null;
  stallNumber?: string | null;
  operatingSchedule?: { days?: string[]; open?: string; close?: string } | null;
  hasPhysicalStock?: boolean | null;
  estimatedInventoryValue?: string | null;
  stockLocation?: string | null;
  minimumOrderValueKobo?: number | null;
  offersSameDayFulfillment?: boolean | null;
